...
\begin{resume_section}{Relevant Experience}
    \begin{resume_employer}{Bishop Fox}{Incoming Security Consultant I}{May 2022}
        \begin{subitems}
        \item Incoming penetration tester intern at Bishop Fox starting in May 2022.
        \end{subitems}
    \end{resume_employer}
\end{resume_section}
...
\begin{resume_section}{Skills}
	\begin{nospacetabbing}
  	...
  	\textbf{Miscellaneous:} \> Cloud services (AWS and Oracle), GNU/Linux, Bash, Git, Latex, Excel, Autodesk Inventor.\\*
...
\begin{resume_section}{Associations}
    \begin{resume_employer}{Devilsec}{}{August 2020 - Present}
        ...
        \begin{resume_position}{Vice-President}{2022 - Present}
            \item Deployed and configured a CTF platform to allow the club to host CTFs and CTF based workshops.
