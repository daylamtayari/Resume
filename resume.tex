...
\begin{resume_section}{Relevant Experience}
    \begin{resume_employer}{Bishop Fox}{Incoming Security Consultant I}{May 2022}
        \begin{subitems}
        \item Incoming security consultant I at Bishop Fox starting in May 2022.
        \end{subitems}
    \end{resume_employer}
\end{resume_section}
...
\begin{resume_section}{Skills}
    ...
    \textbf{Languages:} \hspace{5em} \=Java, Python, C++, C, Go, SQL, JavaScript, TypeScript, HTML, CSS.\\*
